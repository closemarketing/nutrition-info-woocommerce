...
if ( 'after_product_summary' === get_option( 'wc_nutrients_settings_tab_position' ) ) {
...
if ( 'after_add_to_cart' === get_option( 'wc_nutrients_settings_tab_position' ) ) {
...
if ( 'after_excerpt' === get_option( 'wc_nutrients_settings_tab_position' ) ) {
...
if ( 'after_price' === get_option( 'wc_nutrients_settings_tab_position' ) ) {
...
if ( 'in_description_tab' === get_option( 'wc_nutrients_settings_tab_position' ) ) {
	add_filter( 'woocommerce_product_tabs', 'niw_custom_description_tab', 98 );
}

/**
 * Override description tab callback.
 *
 * @param array $tabs Product tabs.
 * @return array
 */
function niw_custom_description_tab( $tabs ) {
	$tabs['description']['callback'] = 'niw_custom_description_tab_content';
	return $tabs;
}
...
/**
 * Show allergen icons in product loop.
 */
...
/**
 * Show vegan icon on single product page.
 */
...
/**
 * Show allergen/vegan icons before product thumbnail in shop loop.
 */
